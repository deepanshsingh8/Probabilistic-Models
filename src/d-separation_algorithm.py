...
def d_seperation(G, X, Y, Z):
    ...
    temp_dict = refine_graph(G, X, Y, Z,
                             union)  # this is a recursive function which removes all the leaf nodes and the node that is not required.
